...
class Backups:
  ...
  def run(self, command):
    logging_debu("Running %s" % (command))
  ...
  def backup(self, db=None):
    ...
    if db:
      logging_debu('Dumping the database %s' % (db))
  ...
  def dump_server(self):
    logging_debu('Dumping all databases')
  ...
  def dump_databases(self):
    logging_debu('Dumping individual databases')
  ...
  def dump_database(self, database):
    logging_debu('Dumping database %s' % (database))
